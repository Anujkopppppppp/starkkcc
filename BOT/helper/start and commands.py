...
Thunder Checker  Has plenty of Commands . We Have Auth Gates , Charge Gates , Tools And Other Things .
...
<b>Welcome aboard the Thunder Checker! 🚀</b>
...
Click Each of Them Below to Know Them Better.</b>
    ...
    if CallbackQuery.data == "close":
        ...
        await CallbackQuery.message.reply_text("Enjoy Dadu, @Stxthunder")
...
Click on each one below to get to know them better. .</b>
    ...
    if CallbackQuery.data == "Auth2":
        CHARGE_TEXT = """
🔹 Stripe Auth Gates of STARK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BRAINTREEVBV":
        CHARGE_TEXT = """
🔹 Braintree Gates of THUNDER Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BRAINTREEB3":
        CHARGE_TEXT = """
🔹 Braintree B3 of THUNDER Checker
🔹 Status: ✅ Active
...
Click on each one below to get to know them better. .</b>
    ...
    if CallbackQuery.data == "PAYPAL":
        CHARGE_TEXT = """
🔹 PayPal Charge Gates of THUNDER Checker
🔹 Status: ❌ Inactive
...
"""
    ...
    if CallbackQuery.data == "SKBASED":
        CHARGE_TEXT = """
🔹 Stripe Charge Gates of THUNDER Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "SITE":
        CHARGE_TEXT = """
🔹 Site Charge Gates of THUNDER Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BRAINTREE":
        CHARGE_TEXT = """
🔹 Braintree Charge Gates of THUNDER Checker
🔹 Status: ✅ Active
...
🔹 Shopify Charge Gates of THUNDER Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "SCRAPPER":
        CHARGE_TEXT = """
🔹 Scrapper Tools Gates of THUNDER Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "GENARATORTOOLS":
        CHARGE_TEXT = """
🔹 Generator Tools of THUNDER Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BINANDOTHERS":
        CHARGE_TEXT = """
🔹 Bin and Other Tools Of THUNDER Checker
🔹 Status: ✅ Active
...
Click on each one below to get to know them better.</b>
    ...
    if CallbackQuery.data == "INFO":
        CHARGE_TEXT = """
🔹 Helper Gates of THUNDER Checker
🔹 Status: ✅ Active

🚀 Quick Commands Overview:

👤 Account Management:
   1. Start Bot: /start@StarkCccheckerbot
   2. Register: /register
   3. User ID: /id
   4. User Info: /info
